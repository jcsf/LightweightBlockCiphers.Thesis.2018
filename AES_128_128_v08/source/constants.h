...
extern uint32_t inv_T1[256];
extern uint32_t inv_T2[256];
extern uint32_t inv_T3[256];

extern uint32_t inv_MC0[256];
extern uint32_t inv_MC1[256];
extern uint32_t inv_MC2[256];
extern uint32_t inv_MC3[256];
