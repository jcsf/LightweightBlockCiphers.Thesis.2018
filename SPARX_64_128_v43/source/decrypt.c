...
#define round(left, right, r, temp, roundKeys32)\
{\
    roundKeys32 -= 6; \
    \
    /* linear layer */ \
...
void Decrypt(uint8_t *block, uint8_t *roundKeys)
{
    ...
    round(left, right, r, temp, roundKeys32); // 1
    round(left, right, r, temp, roundKeys32); // 2
    round(left, right, r, temp, roundKeys32); // 3
    round(left, right, r, temp, roundKeys32); // 4
    round(left, right, r, temp, roundKeys32); // 5
    round(left, right, r, temp, roundKeys32); // 6
    round(left, right, r, temp, roundKeys32); // 7
    round(left, right, r, temp, roundKeys32); // 8
