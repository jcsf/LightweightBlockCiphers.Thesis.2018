...
{ \
	...
	inv_T3(t3) \
	t3 = t3 ^ t2; \
	(y0) = t3 ^ READ_ROUND_KEY_DOUBLE_WORD(((uint32_t*)keys)[4*r - 4]);   \
	\
	t4 = (uint8_t)(x1);      \
	inv_T0(t4) \
	t5 = (uint8_t)((x0) >> 8); \
	...
	inv_T3(t7) \
	t7 = t7 ^ t6; \
	(y1) = t7 ^ READ_ROUND_KEY_DOUBLE_WORD(((uint32_t*)keys)[4 * r - 3]);   \
	\
	t8 = (uint8_t)(x2);          \
	inv_T0(t8) \
	t9 = (uint8_t)((x1) >> 8);     \
	...
	inv_T3(t15) \
	t15 = t15 ^ t14; \
	(y3) = t15 ^ READ_ROUND_KEY_DOUBLE_WORD(((uint32_t*)keys)[4 * r - 1]); \
}
