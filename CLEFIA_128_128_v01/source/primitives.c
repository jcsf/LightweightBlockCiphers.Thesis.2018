...
void ByteCpy(uint8_t *dst, const uint8_t *src, int8_t bytelen)
{
  while(bytelen-- > 0){
    *dst++ = *src++;
  }
...
void ByteXor(uint8_t *dst, const uint8_t *a, const uint8_t *b, int8_t bytelen)
{
  while(bytelen-- > 0){
    *dst++ = *a++ ^ *b++;
  }
...
void ClefiaGfn4(uint8_t *y, const uint8_t *x, const uint8_t *rk, int8_t r)
{
...
void ClefiaGfn4Inv(uint8_t *y, const uint8_t *x, const uint8_t *rk, int8_t r)
{
  uint8_t fin[16], fout[16];
