 ...
 *
 */
extern void ByteCpy(uint8_t *dst, const uint8_t *src, int8_t bytelen);
extern void ByteXor(uint8_t *dst, const uint8_t *a, const uint8_t *b, int8_t bytelen);
...
extern void ClefiaGfn4(uint8_t *y, const uint8_t *x, const uint8_t *rk, int8_t r);
extern void ClefiaGfn8(uint8_t *y, const uint8_t *x, const uint8_t *rk, int8_t r);
extern void ClefiaGfn4Inv(uint8_t *y, const uint8_t *x, const uint8_t *rk, int8_t r);
